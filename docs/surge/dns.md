...
### 代理请求使用本地 DNS {#proxy-use-local-dns}
...
### 指定域名加密 DNS {#per-domain-encrypted-dns}
...
### 通过代理使用加密 DNS {#encrypted-dns-via-proxy}
