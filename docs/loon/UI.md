...
![1.4.1](Photo/1.4.1.webp){: width=900}
...
![1.4.2](Photo/1.4.2.webp){: width=300}
...
![1.4.3](Photo/1.4.3.webp){: width=900}
...
![1.4.4](Photo/1.4.4.webp){: width=600}

当使用脚本对请求进行处理时，🔒的右侧会有绿色文件夹📁图标


![1.4.5](Photo/1.4.5.webp){: width=600}


当使用复写规则对请求进行处理时，🔒的右侧会有紫色文件夹📁图标

![1.4.6](Photo/1.4.6.webp){: width=600}
...
<img src="../quantumultx/Photo/UI7-3.webp" width="900">


- Telegram中为`SOCKS5`代理

<img src="../quantumultx/Photo/UI7-4.webp" width="600">
...
![1.9.2](Photo/1.9.2.webp){: width=600}
...
![1.10](Photo/1.10.webp){: width=900}
...
![1.11](Photo/1.11.webp){: width=1200}
...
![1.13](Photo/1.13.webp){: width=1200}
...
![1.15.1](Photo/1.15.1.webp){: width=900}


长按策略组进行编辑或修改图标

![1.15.2](Photo/1.15.2.webp){: width=900}
...
![1.15.3](Photo/1.15.3.webp){: width=900}

![1.15.4](Photo/1.15.4.webp){: width=900}
