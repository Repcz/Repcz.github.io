...
<a href="https://apps.apple.com/app/id1596063349"><img width="200px" alt="Download on App Store" src="https://developer.apple.com/assets/elements/badges/download-on-the-app-store.svg"/></a>
...
> **_Stash_** 自带 **Sub-Store**，机场订阅本地转换可参考[Sub-Store 教程](../substore/use.md#_3)
...
![s1](Photo/s1.webp){: width=900}

导入节点订阅

![s2](Photo/s2.webp){: width=900}



导入节点订阅信息显示

![s3](Photo/s3.webp){: width=600}
...
![s5.1](Photo/s5.1.webp){: width=900}


### 安装证书


![s6](Photo/s6.webp){: width=900}

### 信任证书

![s7](Photo/s7.webp){: width=600}
...
<img src="../quantumultx/Photo/raw1.webp" >

<img src="../quantumultx/Photo/raw2.webp" >
