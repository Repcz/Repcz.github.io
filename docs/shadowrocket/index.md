...
<a href="https://apps.apple.com/app/id932747118"><img width="200px" alt="Download on App Store" src="https://developer.apple.com/assets/elements/badges/download-on-the-app-store.svg"/></a>

## 机场订阅

![1](Photo/1.webp){: width=900}
...
![6.1](Photo/6.1.webp){: width=1200}

### 安装证书

点击 **安装证书** ，点击 **允许** ，选择 iPhone

![6.2](Photo/6.2.webp){: width=900}



系统设置中，点击 **已下载描述文件** ，点击 **安装** 

![6.3](Photo/6.3.webp){: width=900}
...
![6.4](Photo/6.4.webp){: width=1200}

## 安装模块

<!-- prettier-ignore -->
!!! 警告
    模块功能大多依赖于 [证书设置](index.md?#_7) 中安装信任的根证书


底部工具栏 **配置** → **模块** → 右上角 `➕`

![7](Photo/7.webp){: width=600}
